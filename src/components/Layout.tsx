...
import { Menu, Calendar, Package2, Settings } from 'lucide-react';
...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-50 to-indigo-50">
      ...
      <div
        className={`
          fixed inset-y-0 left-0 z-50 w-64 transform bg-white
          lg:transform-none lg:opacity-100 lg:relative lg:z-0
